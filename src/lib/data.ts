export const personalInfo = {
  ...
  heroDescription:
    "Saya adalah seorang Web Developer yang memiliki keahlian dalam membangun website dan aplikasi web yang fungsional, responsif, dan berorientasi pada pengalaman pengguna. Dengan pengalaman menggunakan teknologi modern seperti React, Next.js, TailwindCSS, dan REST API, saya mampu merancang tampilan antarmuka yang menarik sekaligus memastikan performa yang optimal.",
};
...
export const skills = {
  programmingLanguages: ["JavaScript", "TypeScript", "Go", "PHP", "Python"],
  frontendDevelopment: [
    "React",
    "Next.js",
    "TypeScript",
