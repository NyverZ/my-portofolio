...
export default function AwardsSection() {
  return (
    <section
      id="awards"
      className="py-12 bg-linear-to-b from-background to-muted/10"
    >
              ...
              <GlassCard className="p-4 dark:border-purple-500/10 hover:border-purple-500/30 transition-all duration-300 flex flex-col h-full">
                <div className="flex items-center mb-2">
                  <motion.div
                    ...
                    className="flex items-center justify-center bg-linear-to-r from-amber-500 to-yellow-500 rounded-full p-1.5 mr-2"
                  >
